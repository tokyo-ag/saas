...
export const metadata: Metadata = {
  ...
  description:
    '東京の20代向けフットサルサークルを探すならAtsumaro。池袋・豊島区を拠点に板橋・北区・練馬区エリアで開催多数。初心者歓迎・社会人歓迎。LINEで簡単に参加申込・リマインド通知。無料で始められます。',
  keywords: [
    'フットサルサークル',
    '東京',
    '20代',
  ...
  openGraph: {
    title: 'フットサルサークル 東京 20代 | Atsumaro',
    description:
...
const FAQ_ITEMS = [
  {
    question: 'フットサルサークルに初心者でも参加できますか？',
    answer:
      'はい、掲載されているサークルの多くは初心者歓迎です。サッカー経験がない方でも参加できるサークルが多数あります。各イベント詳細ページで「初心者OK」「経験不問」などの条件を確認できます。',
  },
  {
    question: '20代社会人でも参加しやすいですか？',
    answer:
      '東京の20代社会人向けサークルが多数登録されています。平日夜・週末開催のイベントが充実しており、仕事終わりでも参加しやすい環境です。同世代が集まるので初参加でも打ち解けやすいです。',
  },
  {
  ...
  },
  {
    ...
    answer:
      '各サークル・イベントによって異なります。コート代・ボール代込みで500〜1,500円程度のイベントが多いです。無料のサークルもあります。イベント詳細ページに参加費が明記されているので事前に確認できます。',
  },
  {
    question: '東京のどのエリアで開催していますか？',
    answer:
      '池袋（豊島区）を拠点に、板橋区・北区・練馬区・文京区など池袋周辺エリアのフットサルコートを中心に開催されています。屋内・屋外どちらのコートも含まれます。エリアはイベントによって異なりますので、詳細ページでご確認ください。',
  },
]

export default function FutsalTokyoPage() {
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        '@type': 'BreadcrumbList',
        itemListElement: [
          { '@type': 'ListItem', position: 1, name: 'ホーム', item: 'https://atsumaro.jp' },
          { '@type': 'ListItem', position: 2, name: '活用事例', item: 'https://atsumaro.jp/use-cases' },
          { '@type': 'ListItem', position: 3, name: 'フットサルサークル 東京 20代', item: 'https://atsumaro.jp/use-cases/futsal-tokyo' },
        ],
      },
      {
        '@type': 'FAQPage',
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="px-4 py-16 bg-gradient-to-br from-[#06C755] to-[#047a35] text-white text-center">
          <div className="max-w-xl mx-auto">
            <h2 className="text-2xl font-bold mb-3">東京でフットサル仲間を見つけよう</h2>
