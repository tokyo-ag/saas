...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/use-cases/basketball-tokyo`,
  },
  openGraph: {
    title: 'バスケットボールサークル 東京 20代 | COMIU',
    description:
      '東京20代向けバスケットボールサークル。池袋・豊島区拠点。初心者歓迎・社会人歓迎。LINEで簡単参加申込。',
    locale: 'ja_JP',
    type: 'website',
...
const FAQ_ITEMS = [
  {
    question: 'バスケットボールサークルに初心者でも参加できますか？',
    answer:
      'はい、掲載されているサークルの多くは初心者歓迎です。基本的なドリブルやシュートから教えてもらえるサークルが多く、経験がない方でも気軽に参加できます。各イベント詳細ページで「初心者OK」「経験不問」などの条件を確認できます。',
  },
  {
    question: '20代社会人でも参加しやすいですか？',
    answer:
      '東京の20代社会人向けサークルが多数登録されています。平日夜・週末開催のイベントが充実しており、仕事終わりや休日にも参加しやすい環境が整っています。同世代の参加者が多いので初めての方も馴染みやすいです。',
  },
  {
  ...
  },
  {
    ...
    answer:
      '体育館のコート代を参加者で割り勘するスタイルが多く、500〜1,500円程度のイベントが一般的です。イベント詳細ページに参加費が明記されているので事前に確認できます。',
  },
  {
...
export default function BasketballTokyoPage() {
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'バスケットボールサークル 東京 20代', item: `${SITE_URL}/use-cases/basketball-tokyo` },
        ],
      },
      {
        '@type': 'FAQPage',
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="bg-gradient-to-br from-[#06C755] to-[#047a35] text-white px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl md:text-4xl font-bold leading-tight mb-4">
              バスケットボールサークル 東京 20代向け<br />
              イベント管理・参加予約をLINEで完結
            </h1>
            <p className="text-white/85 text-base md:text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
              池袋を拠点に豊島区・板橋区・北区・文京区エリアで、東京の20代向けバスケットボールサークルが多数登録。
              初心者歓迎・社会人歓迎のイベントを、LINEからかんたんに申込・管理できます。
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link href="/sports/basketball" className="w-full sm:w-auto bg-white text-[#06C755] font-bold px-8 py-4 rounded-2xl hover:bg-gray-50 transition-colors text-center">
                イベントを探す
              </Link>
        ...
        <section className="px-4 py-16 bg-gradient-to-br from-[#06C755] to-[#047a35] text-white text-center">
          <div className="max-w-xl mx-auto">
            <h2 className="text-2xl font-bold mb-3">東京でバスケ仲間を見つけよう</h2>
            <p className="text-white/80 text-sm mb-8 leading-relaxed">
              20代・初心者歓迎のサークルが多数。まずはイベントを探してみてください。
              主催者の方は無料でサークルを登録できます。
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link href="/sports/basketball" className="w-full sm:w-auto bg-white text-[#06C755] font-bold px-8 py-4 rounded-2xl hover:bg-gray-50 transition-colors">イベントを探す</Link>
        ...
        <footer className="px-4 py-8 border-t border-gray-100 text-center">
          <div className="flex items-center justify-center gap-4 mb-4 text-sm text-gray-400">
            <Link href="/sports/basketball" className="hover:text-gray-600">バスケイベント一覧</Link>
