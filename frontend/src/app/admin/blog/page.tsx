      ...
      <div className="mx-auto max-w-3xl px-4 py-6 md:px-6">
        ...
        <div className="space-y-4 rounded-xl border border-gray-200 bg-white p-5">
          ...
          <div>
            ...
            <p className="mb-1 text-xs text-gray-400">AIに書かせた原稿をそのまま貼り付けると、1行目→タイトル、2行目以降の段落→概要に自動で振り分けられます。本文中の「# 見出し」「**太字**」「- 箇条書き」「1. 番号リスト」「&gt; 引用」「Q: 質問 / A: 回答」「!ヒント」「表（Markdown表記法）」「---区切り線」はそのまま装飾として表示されます</p>
