...
import { api, AdminEventReview, AdminTenantReview, Event, formatDate } from '@/lib/api';
    ...
    <div className="px-4 py-4 md:px-6 md:py-6">
      ...
      <div className="mb-5 rounded-xl border border-gray-200 bg-white p-4 shadow-sm md:p-5">
        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm font-bold text-gray-800">イベントごとの感想の投稿条件</p>
            <p className="mt-1 text-xs leading-relaxed text-gray-500">
              下の「イベントごとの感想」（各イベントページの「参加者の声」に表示）にのみ適用されます。
              {requireReservation
                ? '予約済み・参加済みのイベントについてのみ、参加者が感想を投稿できます（なりすまし防止）'
                : 'LINE連携済みのメンバーであれば、予約の有無に関わらず感想を投稿できます'}
            </p>
          </div>
          <button
            type="button"
      ...
      <div className="mb-3">
        <h2 className="text-sm font-bold text-gray-800">イベントごとの感想</h2>
        <p className="mt-1 text-xs text-gray-400">各イベントの詳細ページに「参加者の声」として表示されます。</p>
      </div>
