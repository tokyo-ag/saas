        ...
        <div className="sticky top-0 z-10 bg-white border-b border-gray-100">
          <div className="flex items-center justify-between px-4 pt-12 pb-3">
            ...
            <Link
              ...
              className="flex items-center gap-1.5 bg-[#06C755] text-white text-xs font-bold px-3 py-1.5 rounded-full active:bg-[#05a847]"
            >
          ...
          <div className="space-y-2 mb-4">
            ...
            >
              {organizerPicture ? (
                ...
                <div className="w-12 h-12 rounded-full bg-[#06C755]/15 flex items-center justify-center text-sm font-bold text-[#06C755] shrink-0">
